    ...
    public class GateSpawnSingle : IGateSpawner
    {
        ...
        public (EnemyEntity, TowerEntity)[] Spawn(Vector2 gatePosition, int enemyId, EnemyEntity enemyPrefab, TowerEntity[] targetTower)
        {
            ...
            enemy.transform.position =
                ...
                (Quaternion.Euler(0f, 0f, RandomUtil.Range(-randomSpanAngle / 2, randomSpanAngle / 2)) * (target.transform.position - (Vector3)gatePosition).normalized)
                * radius;
    ...
    public class GateSpawnTriangle : IGateSpawner
    {
        ...
        public (EnemyEntity, TowerEntity)[] Spawn(Vector2 gatePosition, int enemyId, EnemyEntity enemyPrefab, TowerEntity[] targetTower)
        {
            ...
            enemies[0].transform.position =
                (Vector3)gatePosition + 
                (Quaternion.Euler(0f, 0f, RandomUtil.Range(-randomSpanAngle / 2, randomSpanAngle / 2)) * (targets[0].transform.position - (Vector3)gatePosition).normalized)
                * radius;
            ...
            enemies[1].transform.position =
                (Vector3)gatePosition + 
                (Quaternion.Euler(0f, 0f, RandomUtil.Range(-randomSpanAngle / 2, randomSpanAngle / 2)) * (targets[1].transform.position - (Vector3)gatePosition).normalized)
                * radius;
            ...
            enemies[2].transform.position =
                (Vector3)gatePosition + 
                (Quaternion.Euler(0f, 0f, RandomUtil.Range(-randomSpanAngle / 2, randomSpanAngle / 2)) * (targets[2].transform.position - (Vector3)gatePosition).normalized)
                * radius;

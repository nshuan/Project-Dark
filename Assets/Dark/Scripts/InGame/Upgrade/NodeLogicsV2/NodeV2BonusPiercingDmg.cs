...
{
    [Serializable]
    [ConfigNodeLogicTypeV2(NodeBonusTypeV2.BonusPiercingDmg)]
    public class NodeV2BonusPiercingDmg : INodeActivateLogicV2, INodeLogicGeneratorV2
    {
        public float[] value;
        public bool isMul;
        ...
        public void ActivateNode(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            if (isMul) bonusInfo.bonusNormalAttack.bonusPiercingDmg.mul += value[level - 1];
            else bonusInfo.bonusNormalAttack.bonusPiercingDmg.add += value[level - 1];
        }
        ...
        public (string, string) GetBeforeAfterValueTotalStat(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            var dmgMultiply = bonusInfo.bonusNormalAttack.bonusPiercingDmg.mul;
            var dmgPlus = bonusInfo.bonusNormalAttack.bonusPiercingDmg.add;
        ...
        public INodeActivateLogicV2 Generate(string subType, List<string> listValue, bool mul)
        {
            ...
            {
                throw new Exception($"Invalid BonusPiercingDmg value string: {listValue[0]}");
            }
        }
    }
}

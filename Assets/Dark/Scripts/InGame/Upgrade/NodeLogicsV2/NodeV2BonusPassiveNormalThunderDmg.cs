...
{
    [Serializable]
    [ConfigNodeLogicTypeV2(NodeBonusTypeV2.BonusPassiveNormalThunderDmg)]
    public class NodeV2BonusPassiveNormalThunderDmg : INodeActivateLogicV2, INodeLogicGeneratorV2
    {
        public float[] value;
        public bool isMul;
        ...
        public void ActivateNode(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            if (isMul) bonusInfo.bonusPassiveNormalAttack.bonusThunderDmg.mul += value[level - 1];
            else bonusInfo.bonusPassiveNormalAttack.bonusThunderDmg.add += value[level - 1];
        }
        ...
        public (string, string) GetBeforeAfterValueTotalStat(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            var thunderDmgMultiply = bonusInfo.bonusPassiveNormalAttack.bonusThunderDmg.mul;
            var thunderDmgPlus = bonusInfo.bonusPassiveNormalAttack.bonusThunderDmg.add;
        ...
        public INodeActivateLogicV2 Generate(string subType, List<string> listValue, bool mul)
        {
            ...
            {
                throw new Exception($"Invalid BonusPassiveNormalThunderDmg value string: {listValue[0]}");
            }
        }
    }
}

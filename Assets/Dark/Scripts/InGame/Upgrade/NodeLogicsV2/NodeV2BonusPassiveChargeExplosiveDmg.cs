...
{
    [Serializable]
    [ConfigNodeLogicTypeV2(NodeBonusTypeV2.BonusPassiveChargeExplosiveDmg)]
    public class NodeV2BonusPassiveChargeExplosiveDmg : INodeActivateLogicV2, INodeLogicGeneratorV2
    {
        public float[] value;
        public bool isMul;
        ...
        public void ActivateNode(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            if (isMul) bonusInfo.bonusPassiveChargeAttack.bonusExplosiveDmg.mul += value[level - 1];
            else bonusInfo.bonusPassiveChargeAttack.bonusExplosiveDmg.add += value[level - 1];
        }
        ...
        public (string, string) GetBeforeAfterValueTotalStat(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            var explosiveDmgMultiply = bonusInfo.bonusPassiveChargeAttack.bonusExplosiveDmg.mul;
            var explosiveDmgPlus = bonusInfo.bonusPassiveChargeAttack.bonusExplosiveDmg.add;
        ...
        public INodeActivateLogicV2 Generate(string subType, List<string> listValue, bool mul)
        {
            ...
            {
                throw new Exception($"Invalid BonusPassiveChargeExplosiveDmg value string: {listValue[0]}");
            }
        }
    }
}

...
{
    [Serializable]
    [ConfigNodeLogicTypeV2(NodeBonusTypeV2.BonusPassiveCounterLightningRate)]
    public class NodeV2BonusPassiveCounterLightningRate : INodeActivateLogicV2, INodeLogicGeneratorV2
    {
        public float[] value;
        public bool isMul;
        ...
        public void ActivateNode(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            if (isMul) bonusInfo.bonusPassiveCounter.bonusLightningRate.mul += value[level - 1];
            else bonusInfo.bonusPassiveCounter.bonusLightningRate.add += value[level - 1];
        }
        ...
        public (string, string) GetBeforeAfterValueTotalStat(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            var lightningRateMultiply = bonusInfo.bonusPassiveCounter.bonusLightningRate.mul;
            var lightningRatePlus = bonusInfo.bonusPassiveCounter.bonusLightningRate.add;
        ...
        public INodeActivateLogicV2 Generate(string subType, List<string> listValue, bool mul)
        {
            ...
            {
                throw new Exception($"Invalid BonusPassiveCounterLightningRate value string: {listValue[0]}");
            }
        }
    }
}

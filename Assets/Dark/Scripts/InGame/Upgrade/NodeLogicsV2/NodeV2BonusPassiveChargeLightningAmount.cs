...
{
    [Serializable]
    [ConfigNodeLogicTypeV2(NodeBonusTypeV2.BonusPassiveChargeLightningAmount)]
    public class NodeV2BonusPassiveChargeLightningAmount : INodeActivateLogicV2, INodeLogicGeneratorV2
    {
        public float[] value;
        public bool isMul;
        ...
        public void ActivateNode(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            if (isMul) bonusInfo.bonusPassiveChargeAttack.bonusLightningAmount.mul += value[level - 1];
            else bonusInfo.bonusPassiveChargeAttack.bonusLightningAmount.add += value[level - 1];
        }
        ...
        public (string, string) GetBeforeAfterValueTotalStat(int level, ref UpgradeBonusInfoV2 bonusInfo)
        {
            ...
            var lightningAmountMultiply = bonusInfo.bonusPassiveChargeAttack.bonusLightningAmount.mul;
            var lightningAmountPlus = bonusInfo.bonusPassiveChargeAttack.bonusLightningAmount.add;
        ...
        public INodeActivateLogicV2 Generate(string subType, List<string> listValue, bool mul)
        {
            ...
            {
                throw new Exception($"Invalid BonusPassiveChargeLightningAmount value string: {listValue[0]}");
            }
        }
    }
}
